...
VALIDITY () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/imam022/titid/main/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/imam022/titid/main/ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/remakev1/main/cert.sh"
